...
$pc;
    ...
    $query=("SELECT procat FROM cvs WHERE username='$tmp' ");
 ...
 $query2=("SELECT * FROM company WHERE companytype='$pc' ");
    ...
    while($row2=mysql_fetch_array($result2)){
        ...
        <img src="'.$logo.'" alt="not found" height="100" width="100" />
        <br><br><br>
        
        
        <a href="comdisplay.php?com='.$cname.'"><h2>'.$cname.'</h2></a>
