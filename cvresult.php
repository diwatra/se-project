<!DOCTYPE html>
<!-- saved from url=(0046)/signup.html -->
...
$ss  = $_GET["searchschool"];
    
$sc = $_GET["searchcollege"];

$su  = $_GET["searchuniversity"];
    


$sp  = $_GET["searchprojects"];
    
$sa  = $_GET["searchachievements"];
    ...
    $query=("SELECT * FROM cvs WHERE School like '%$ss%' and '$ss'!='' or College like '%$sc%' and '$sc'!='' or University like '%$su%' and '$su'!='' or Projects like '%$sp%' and '$sp'!='' or Achievements like '%$sa%' and '$sa'!=''    ");
    ...
    while($row=mysql_fetch_array($result)){
        ...
        $photo=$row['photo'];
        $ms=$row['MajorSkills'];
        $ts=$row['TechnicalSkills'];
        $os=$row['OtherSkills'];
        $pro=$row['Projects'];
        $ach=$row['Achievements'];
        
        $query2=("select * from exp where Email='$email'");
...
<section class="signup-section">
    ...
    <section>
			...
			<div class="sectionContent">
				<article>
					<h2>School</h2>
					<p class="subDetails">'.$school.'</p>
					
				</article>
				
				<article>
					<h2>College</h2>
					<p class="subDetails">'.$college.'</p>
					
				</article>
                
                <article>
					<h2>University</h2>
					<p class="subDetails">'.$university.'</p>
