...
<form  method="get" action="cvresult.php" >


    

<div class="input-box"> <i class="fa fa-pencil"></i>
<input type="text" name ="searchschool" placeholder="Search by School">
</div>


<div class="input-box"> <i class="fa fa-pencil"></i>
<input type="text" name ="searchcollege" placeholder="Search by College">
</div>
    
    
<div class="input-box"> <i class="fa fa-pencil"></i>
<input type="text" name ="searchuniversity" placeholder="Search by University">
</div>


<div class="input-box"> <i class="fa fa-pencil"></i>
<input type="text" name ="searchexperience" placeholder="Search by Experience in years">
</div>
    
<div class="input-box"> <i class="fa fa-pencil"></i>
<input type="text" name ="searchprojects" placeholder="Search by Projects">
</div>

    <div class="input-box"> <i class="fa fa-pencil"></i>
<input type="text" name ="searchachievements" placeholder="Search by Achievements">
        <span class="right">
