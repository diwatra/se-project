...
<h1>These Are The Request That You Have Received:</h1>
...
$sqlget="SELECT * FROM `company` WHERE `company`.`companytype` = '$type1' ORDER BY `company`.`companyname` ASC";
$sql_data=mysql_query($sqlget);                                
    ...
    ?>
      <tr bgcolor="<?php ?>">
            ...
            <h3><td><?php echo $row[0]; ?></td><td><?php echo $row['3']; ?></td>
                <td><?php echo $row[4]; ?></td><td><?php echo $row['5']; ?></td>
                <td><?php echo $row[6]; ?></td><td><?php echo $row['9']; ?></td>
                <td><input type="submit" name ="contact" value="Contact"></td></h3>
