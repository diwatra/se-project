...
<form action="open-job.php" method="post">
...
<input type="text" name ="type" placeholder="Job Type(keyword)">
</div>
<div class="input-box"> <i class="fa fa-unlock"></i>
<input type="text" name ="sal" placeholder="Salary">
</div>
<div class="input-box"> <i class="fa fa-unlock"></i>
<input type="text" name ="work_hr" placeholder="Work Hour Needed">
</div>
<div class="input-box"> <i class="fa fa-unlock"></i>
<input type="text" name ="dead" placeholder="Deadline(Time It Should Be Completed)">
</div>

<input type="submit" name ="signin" value="Open the Job">
</form>
</div>
</div>
</section>
...
if(isset($_POST['signin']))
{
    ...
    $user1234 = fgets($myfile);
    fclose($myfile);
    
    $name1=$_POST['name'];
	$type1=$_POST['type'];
    $sal1=$_POST['sal'];
    $work_hr1=$_POST['work_hr'];
	$dead1=$_POST['dead'];
    
    $que=("insert into openjob (jobname,jobtype,salary,workhour,deadline,companyname) VALUE ('$name1','$type1','$sal1','$work_hr1','$dead1','$user1234')");
    ...
    {
        echo "<script>alert('Sorry !!! job NOT inserted')</script>";
    }
