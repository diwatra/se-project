...
<input type="text" name ="add" placeholder="Your Office Address">
</div>
<div class="input-box"> <i class="fa fa-unlock"></i>
<input type="text" name ="about" placeholder="Company Description(About us)">
</div>
...
<section class="resum-form padd-tb" align="center">

    
<div class="col-md-6 col-sm-6">
    <form method="post" action="comp-update.php" enctype="multipart/form-data">
...
<input type="file" name="file"/>
        ...
        <input type="submit" name="photo" value="Upload Logo">  
  </form>
</div>
...
$myfile = fopen("openjob.txt", "r") or die("Unable to open file!");
    $cname1 = fgets($myfile);
    fclose($myfile);
...
$location= 'com-images/';
  ...
  if ( move_uploaded_file($tmp_name,$location.$namee)){
      
      //echo "<script>alert('track uploaded')</script>";
       echo "<script>alert('Logo Uploaded')</script>";
      
      
      $qry="update company set logo='$ph' where companyname='$cname1'";
...
if(isset($_POST['update']))
{
    ...
    $que=("UPDATE `easyhire`.`company` SET `Address` = '$add1',`Aboutus`='$about1' WHERE `company`.`companyname` = '$cname'");
    ...
    {
        echo "<script>alert('Sorry Error!!! information not updated')</script>";
    }
